...
| 2026-08-18 | Publier des balises canoniques et Open Graph pointant vers l'URL GitHub Pages. | Le site n'a qu'un seul hote a ce jour ; l'apercu de partage est critique car WhatsApp est le canal de contact principal du groupe. | **A mettre a jour le jour du passage sur le domaine propre** : `canonical`, `og:url`, `sitemap.xml`, `robots.txt` et les URL des donnees structurees. |
