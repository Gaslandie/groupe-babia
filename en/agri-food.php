    ...
    <main id="content" tabindex="-1">
      ...
      <section class="section two-column">
        ...
        <div class="content-panel">
          ...
          <ul class="check-list">
            <li>Request path by email or WhatsApp, with direct qualification from the catalog.</li>
      ...
      <section class="contact-band">
        <div>
          ...
          <p>Browse the catalog or send us your requirement sheet directly.</p>
        </div>
