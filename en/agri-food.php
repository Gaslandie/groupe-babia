...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://www.groupebabia.com/en/agri-food.php">
    <link rel="alternate" hreflang="fr" href="https://www.groupebabia.com/agroalimentaire.php">
    <link rel="alternate" hreflang="en" href="https://www.groupebabia.com/en/agri-food.php">
  ...
  <body>
    ...
    <header class="site-header" data-header>
      ...
      <nav class="site-nav" id="site-nav" data-nav>        <a href="/en/">Home</a>
        ...
        <a class="language-link" href="../agroalimentaire.php" hreflang="fr">FR</a>
      </nav>
    </header>
    <main id="content" tabindex="-1">
      <section class="page-hero">
        <img class="page-hero-media" src="../assets/images/agro-cajou.webp?v=20260918" alt="" width="736" height="736" fetchpriority="high" decoding="async">
      ...
      <section class="section media-band" id="crops">
        <img src="../assets/images/mais.webp" alt="Maize field, food crop production" width="900" height="600" loading="lazy" decoding="async">
        <div>
          <p class="eyebrow">Crop production</p>
          <h2>Rice, maize, vegetables and cash crops</h2>
          <p>We invest in modern farming techniques, mechanisation and irrigation to increase productivity. Seeds, fertilisers and equipment are supplied to growers, with support and training for farmers and agricultural cooperatives.</p>
          <ul class="tag-list"><li>Rice</li><li>Maize</li><li>Vegetables</li><li>Cash crops</li></ul>
        </div>
      </section>
