...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Browse the confirmed agri-food export and import product scope of Groupe Babia Guinea.">
    <title>Product Catalog | Groupe Babia Guinea</title>
    ...
    <meta property="og:title" content="Product Catalog | Groupe Babia Guinea">
    <meta property="og:description" content="Browse the confirmed agri-food export and import product scope of Groupe Babia Guinea.">
  ...
  <body>
    ...
    <main id="content" tabindex="-1">
      <section class="page-hero"><img class="page-hero-media" src="../assets/images/soja.webp" alt="" width="1080" height="796" fetchpriority="high" decoding="async"><div class="page-hero-overlay"></div><div><nav class="breadcrumb" aria-label="Breadcrumb"><ol><li><a href="index.php">Home</a></li><li><span aria-current="page">Catalog</span></li></ol></nav><p class="eyebrow">Catalog</p><h1>Products handled by Groupe Babia</h1><p>The catalog presents the agricultural export products and food import products confirmed by the client. For a quotation, share product, volume, destination and timing.</p><div class="page-actions"><a class="button button-primary" href="contact.php#formulaire">Request a quotation</a></div></div><aside class="page-hero-card"><strong>Actionable request</strong><p>Select products, then send a request with quantity, destination, timing, packaging and documents whenever possible.</p></aside></section>
      ...
      <section class="section dark-section">
        <div class="section-heading"><p class="eyebrow">Quotation file</p><h2>Details that help the team respond usefully</h2></div>
        <div class="service-grid"><article class="service-card"><small>01</small><h3>Product and quality</h3><p>Indicate the product, expected quality, grade, moisture or any document required for the purchase.</p></article><article class="service-card"><small>02</small><h3>Volume and timing</h3><p>Specify estimated quantity, order frequency, desired deadline and country or destination area.</p></article><article class="service-card"><small>03</small><h3>Packaging</h3><p>Share the expected format: bags, cartons, drums, pallets, full container or another logistics need.</p></article></div>
        <div class="content-questions"><article><h3>Export products</h3><p>For agricultural exports, add destination, expected quality, packaging and desired shipping period.</p></article><article><h3>Import products</h3><p>For food imports, specify distribution needs, market, packaging format and timing.</p></article><article><h3>Commercial follow-up</h3><p>A structured request helps avoid generic answers and accelerates qualification.</p></article></div>
      </section>
