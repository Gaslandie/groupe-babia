...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Legal notice of Groupe Babia Guinea: website publisher, hosting, intellectual property and limits of liability for the information published.">
    <title>Legal notice | Groupe Babia Guinea</title>
    ...
    <meta property="og:url" content="https://www.groupebabia.com/en/legal.php">
    <meta property="og:title" content="Legal notice | Groupe Babia Guinea">
    <meta property="og:description" content="Legal notice of Groupe Babia Guinea: website publisher, hosting, intellectual property and limits of liability for the information published.">
    <meta property="og:image" content="https://www.groupebabia.com/assets/images/partage-social.jpg">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Legal notice | Groupe Babia Guinea">
    <meta name="twitter:description" content="Legal notice of Groupe Babia Guinea: website publisher, hosting, intellectual property and limits of liability for the information published.">
    ...
    <main id="content" tabindex="-1">
      <section class="page-hero legal-hero">
        ...
        <div>
          ...
          <h1>Legal notice</h1>
          <p>Information about the publisher, the hosting and the use of the Groupe Babia Guinea website.</p>
        </div>
      </section>
      ...
      <section class="section legal-content">
        <article>
          ...
          <p><strong>Groupe Babia Guinea</strong><br>Kaloum, Conakry, Republic of Guinea</p>
          <p>Phone: <a href="tel:+224655903333">+224 655 903 333</a><br>WhatsApp: <a href="https://wa.me/224620903333">+224 620 903 333</a><br>Email: <a href="mailto:contact@groupebabia.com">contact@groupebabia.com</a></p>
          <p>Publication director: General management of Groupe Babia Guinea.</p>
        </article>
        <article>
          <h2>Hosting</h2>
          <p>The website is hosted by Bluehost, a brand of Newfold Digital Inc., 5335 Gate Parkway, Jacksonville, FL 32256, United States.</p>
        </article>
        <article>
          <h2>Intellectual property</h2>
          <p>The texts, visuals, graphic elements, trademarks and logos on this website are protected. Any reproduction, representation or adaptation, in whole or in part, requires the prior authorisation of Groupe Babia Guinea or of the relevant rights holder.</p>
        </article>
        <article>
          <h2>Liability</h2>
          <p>Groupe Babia Guinea takes care to ensure the accuracy of the information published. The commercial information, availability and characteristics presented are indicative and must be confirmed by a formal offer.</p>
        </article>
        <article>
          <h2>Reference version</h2>
          <p>This English version is provided for convenience. The <a href="../mentions-legales.php">French legal notice</a> remains the reference version.</p>
        </article>
      </section>
