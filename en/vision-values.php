    ...
    <main id="content" tabindex="-1">
      ...
      <section class="section soft-section">
        ...
        <div class="commitment-grid value-grid">
          ...
          <article><h3>Excellence</h3><p>Global standards, quality products, commitments delivered and continuous improvement.</p></article>
          ...
          <article><h3>Sustainability</h3><p>Renewable energy, zero-waste thinking, farmer support and profit with purpose.</p></article>
          <article><h3>People first</h3><p>Investing in employees, partner farmers, training, safety and fair wages.</p></article>
      ...
      <section class="section dark-section">
        ...
        <div class="commitment-grid commitment-focus">
          ...
          <article><h3>To customers</h3><p>Offer quality products and services: traceable, safe, accessible and adapted to market needs.</p></article>
          <article><h3>To partners</h3><p>Be a reliable partner for investors, banks, institutions and economic operators.</p></article>
