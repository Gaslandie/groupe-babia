    ...
    <main id="content" tabindex="-1">
      <section class="hero" id="home" aria-label="Groupe Babia Guinea introduction">
        <div class="hero-slide is-active" data-slide>
          <img src="../assets/images/hero-agro-export-import.webp" alt="Agri-food products prepared for export and import" width="1400" height="788" fetchpriority="high" decoding="async">
        </div>
        ...
        <div class="hero-slide" data-slide>
          <img data-src="../assets/images/agro-industrie.webp" alt="Agro-industrial processing unit" width="1400" height="758" decoding="async">
        </div>
      ...
      <section class="section activities-section" id="activities">
        ...
        <div class="activity-grid">
          <article class="activity-card">
            <img src="../assets/images/mais.webp" alt="Maize field, food crop production" width="900" height="600" loading="lazy" decoding="async">
            <div>
              <span>01</span>
              <h3>Agriculture</h3>
              <p>
          ...
          <article class="activity-card">
            <img src="../assets/images/cooperative.webp" alt="Farmer holding grain, partner cooperative" width="900" height="613" loading="lazy" decoding="async">
            <div>
              <span>02</span>
              <h3>Agribusiness</h3>
              <p>
          ...
          <article class="activity-card">
            <img src="../assets/images/agro-industrie.webp" alt="Agro-industrial processing unit" width="1400" height="758" loading="lazy" decoding="async">
            <div>
              <span>03</span>
          ...
          <article class="activity-card">
            <img src="../assets/images/peche.webp" alt="Professional fishing activity" width="1400" height="933" loading="lazy" decoding="async">
            <div>
              <span>04</span>
          ...
          <article class="activity-card">
            <img src="../assets/images/mines.webp" alt="Mining site in operation" width="1400" height="931" loading="lazy" decoding="async">
            <div>
              <span>06</span>
              <h3>Mining</h3>
              <p>
          ...
          <article class="activity-card">
            <img src="../assets/images/logistique-port.webp" alt="Containers at port, import and export logistics" width="900" height="675" loading="lazy" decoding="async">
            <div>
              <span>07</span>
              <h3>Import &amp; export</h3>
              <p>
      ...
      <section class="section export-section" id="export">
        <div class="export-media">
          <ul class="product-wall" aria-label="Import and export products">
            <li>
              <img src="../assets/images/agro-cacao.webp" alt="Cocoa beans" width="1080" height="656" loading="lazy" decoding="async">
              <span><small>Export</small>Cocoa beans</span>
            </li>
            <li>
              <img src="../assets/images/cafe.webp" alt="Coffee beans" width="765" height="573" loading="lazy" decoding="async">
            ...
            <li>
              <img src="../assets/images/sesame.webp" alt="Sesame seeds" width="765" height="573" loading="lazy" decoding="async">
              <span><small>Export</small>Sesame seeds</span>
            </li>
            <li>
              <img src="../assets/images/soja.webp" alt="Soybeans" width="900" height="663" loading="lazy" decoding="async">
              <span><small>Export</small>Soybeans</span>
            </li>
            <li>
              <img src="../assets/images/miel.webp" alt="Honey" width="800" height="600" loading="lazy" decoding="async">
            ...
            <li>
              <img src="../assets/images/oignons.jpeg" alt="Onions" width="640" height="480" loading="lazy" decoding="async">
              <span><small>Import</small>Onions</span>
            </li>
            <li>
              <img src="../assets/images/materiaux-construction.webp" alt="Construction materials" width="900" height="675" loading="lazy" decoding="async">
              <span><small>Import</small>Construction materials</span>
            </li>
          </ul>
        </div>
      ...
      <section class="section soft-section">
        ...
        <div class="news-grid">
          ...
          <article class="news-card">
            <img src="../assets/images/mines.webp" alt="Mining site" width="1400" height="931" loading="lazy" decoding="async">
            <div>
              <small>Mining</small>
      ...
      <div class="footer-card">
        <div class="footer-main">
          ...
          <nav class="footer-columns" aria-label="Footer navigation">
            ...
            <div><strong>Contact</strong><a href="mailto:contact@groupebabia.com">Email</a><a href="tel:+224655903333">+224 655 903 333</a><a href="https://wa.me/224620903333">WhatsApp</a><a href="contact.php#formulaire">Request a quote</a><a href="catalog.php">Product selection</a></div>
          </nav>
        </div>
