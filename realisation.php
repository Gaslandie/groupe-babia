  ...
  <body>
    ...
    <main id="contenu" tabindex="-1">
      <section class="page-hero">
        ...
        <div>
          ...
          <div class="page-actions">
            <a class="button button-primary" href="contact.php#formulaire">Échanger avec l'équipe</a>
        ...
        <article class="content-panel realisation-detail">
          <?php if ($realisation === null): ?>
            ...
            <div class="page-actions">
              ...
              <a class="button button-secondary" href="contact.php">Contacter Groupe Babia</a>
            </div>
          <?php else: ?>
      ...
      <section class="contact-band">
        ...
        <a class="button button-primary" href="contact.php#formulaire">Préparer une demande</a>
      </section>
    </main>
