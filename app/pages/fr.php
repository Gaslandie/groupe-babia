...
$site = [
    ...
    'nav_items' => [
        ...
        'about' => ['label' => 'À propos', 'href' => 'groupe.php'],
        'news' => ['label' => 'Actualités', 'href' => 'realisations.php'],
        'vision-values' => ['label' => 'Vision & valeurs', 'href' => 'vision-valeurs.php'],
        'sectors' => ['label' => 'Nos secteurs', 'href' => 'secteurs.php'],
    ...
    'footer_columns' => [
        ...
        [
            ...
            'links' => [
                ...
                ['label' => 'Actualités', 'href' => 'realisations.php'],
            ],
        ],
        [
            'title' => 'Contact',
...
$pages = [
    'home' => [
        'file' => 'index.html',
        'php' => 'index.php',
        'title' => 'Groupe Babia Guinée SARLU | Groupe diversifié au service de la croissance guinéenne',
        'description' => 'Groupe Babia Guinée SARLU est un groupe guinéen diversifié qui bâtit des infrastructures, renforce la sécurité alimentaire et crée des emplois en Guinée et en Afrique.',
        'active' => 'home',
        'alternate_href' => 'en/',
    ...
    'groupe' => [
        'file' => 'groupe.html',
        'php' => 'groupe.php',
        'title' => 'À propos | Groupe Babia Guinée SARLU',
        'description' => 'Groupe Babia Guinée SARLU est une entreprise guinéenne diversifiée de premier plan, basée à Kaloum, Conakry, avec un impact local et des standards internationaux.',
        'active' => 'about',
    ...
    'vision-valeurs' => [
        'file' => 'vision-valeurs.html',
        'php' => 'vision-valeurs.php',
        'title' => 'Vision & valeurs | Groupe Babia Guinée SARLU',
        'description' => 'Vision, mission, valeurs et engagements de Groupe Babia Guinée SARLU pour l’industrialisation, la sécurité alimentaire et la prospérité durable.',
        'active' => 'vision-values',
        'alternate_href' => 'en/vision-values.php',
        'alternate_canonical' => 'https://www.groupebabia.com/en/vision-values.php',
        'body' => file_get_contents(__DIR__ . '/fr/vision-valeurs.html') ?: '',
    ],
    'secteurs' => [
        'file' => 'secteurs.html',
        'php' => 'secteurs.php',
        'title' => 'Nos secteurs | Groupe Babia Guinée SARLU',
        'description' => 'Les secteurs stratégiques de Groupe Babia Guinée SARLU pour bâtir des infrastructures, renforcer la sécurité alimentaire et créer des emplois.',
        'active' => 'sectors',
        'alternate_href' => 'en/sectors.php',
        'alternate_canonical' => 'https://www.groupebabia.com/en/sectors.php',
        'body' => file_get_contents(__DIR__ . '/fr/secteurs.html') ?: '',
    ],
    'agroalimentaire' => [
        'file' => 'agroalimentaire.html',
        'php' => 'agroalimentaire.php',
        'title' => 'Agroalimentaire | Groupe Babia Guinée',
        'description' => 'Agriculture, agribusiness et agro-industries de Groupe Babia Guinée : production, chaînes de valeur, transformation et création d’emplois.',
        'active' => 'sectors',
    ...
    'btp' => [
        ...
        'description' => 'Construction et BTP de Groupe Babia Guinée : marchés modernes, écoles, bâtiments administratifs, routes, drainage, rénovation et maintenance.',
        'active' => 'sectors',
    ...
    'mines' => [
        ...
        'description' => 'Services de soutien au secteur minier : logistique, transport, approvisionnement, préparation de sites, sous-traitance et facility management.',
        'active' => 'sectors',
    ...
    'catalogue' => [
        ...
        'description' => 'Catalogue import et export de Groupe Babia Guinée : Jus Babia, Tomato Paste Babia, riz, sucre, oignons, matériaux de construction, cacao, café, cajou, sésame, soja et miel.',
        'active' => 'sectors',
    ...
    'contact' => [
        ...
        'description' => 'Contact Groupe Babia Guinée : demande commerciale, projet, partenariat ou information corporate.',
        'active' => 'contact',
